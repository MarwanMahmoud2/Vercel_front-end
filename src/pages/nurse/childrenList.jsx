...
export default function ChildrenList() {
  ...
  const filteredChildren = children.filter(child => {
    ...
    const matchesSearch = nameStr.includes(search.toLowerCase()) ||
      ...
      (child.child_id && child.child_id.toLowerCase().includes(search.toLowerCase()));
                    ...
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-gray-400 font-mono mt-0.5">ID: {child.child_id || child.id}</p>
                        </div>
                      </div>
                    </td>
